...
test('#36184: Copy payment with Save and Close button', async t => {
    const create1 = new ManagePayment()
    const copy1 = new ManagePayment()
    ...
    await copy1.copyPayment2()
    await t.click(detailsSelector.saveCloseBtn)
    //Assert 
    await payment.filterPayment(copy1.codeValue)
    await t
        .expect(indexSelector.paymentTable.innerText).contains(copy1.codeValue)
        .expect(indexSelector.paymentTable.innerText).contains(copy1.nameValue)
        .expect(indexSelector.paymentTable.innerText).contains(copy1.textValue)
    //Delete payment
    await payment.deletePayment()
    await t.expect(indexSelector.paymentTable.innerText).contains('Keine Daten zum Anzeigen')
})

test('#36186: Copy payment with blank Code', async t => {
    ...
    await payment.copyPayment1(' ', ' 30 days', '30 days ')
    await t.click(detailsSelector.saveCloseBtn)
    //Assert 
    await t
...
test('#36187: Edit payment with duplicate Code', async t => {
    ...
    await payment.copyPayment1(create31.codeValue, '30 days', '30 days')
    await t.click(detailsSelector.saveCloseBtn)
    //Assert
    await t
...
test('#36188: Edit payment with Code more than 50 characters', async t => {
    ...
    await payment.copyPayment1('Test new code Test new codeTest new codeTest new codeTest new codeTest new code', '30 net', '30 net')
    await t.click(detailsSelector.saveCloseBtn)
    //Assert 
    await t
...
test('#36189: Edit payment with blank Name', async t => {
    ...
    await payment.copyPayment1('Payment code ', ' ', '30 net')
    await t.click(detailsSelector.saveCloseBtn)
    //Assert 
    await t
        .expect(detailsSelector.vldMessage.innerText).contains('Dieses Feld ist erforderlich')
...
test('#36190: Edit payment with Name more than 254 characters', async t => {
    //Create payment term
    ...
    await payment.copyPayment1('Payment code ', 'Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name Test Payment Name', '30 Net')
    await t.click(detailsSelector.saveCloseBtn)
    //Assert 
    await t
...
test('#36191: Edit payment with blank Text', async t => {
    //Create payment term
...
test('#36192: Edit payment with Text more than 254 characters', async t => {
    //Create payment term
    ...
    await t.click(detailsSelector.saveCloseBtn)
    //Edit payment
    await payment.copyPayment1('Payment code ', 'Payment Name', 'Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text Test Payment Text')
    await t.click(detailsSelector.saveCloseBtn)
    //Assert 
    await t
        .expect(detailsSelector.vldMessage.innerText).contains('Die maximale Länge beträgt 254 Zeichen')
