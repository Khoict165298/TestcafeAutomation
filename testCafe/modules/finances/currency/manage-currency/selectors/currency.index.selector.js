...
export default class CurrencyIndexSelector {
    constructor() {
        //Menu bar
        this.financeMenu = Selector('a').withText("Finanzen")
        this.currencyMenu = Selector('a').withText("Währungen")
        ...
        this.currencyTable = Selector('div').withAttribute('class', 'dxbs-gridview');
